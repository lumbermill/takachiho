class DevicesController < ApplicationController
  ...
  private
    ...
    def device_params
      p = params.require(:device).permit(:device_id, :name, :temp_min, :temp_max, :city_id, :picture, :token4sakura, :device_type, :custom_msg_over, :custom_msg_under, :google_drive_url)
      if p[:picture]

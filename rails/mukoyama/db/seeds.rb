...
if Rails.env == 'development'
	...
	Device.create(id: 1, temp_min: 12, temp_max: 28, user:admin, token4write: 'secret', picture: p1)
	t = Time.now - 1.day
	100.times do
	...
	pictures.each do |p|
		Picture.create(device_id: 1, dt: t, data:p)
		t += 10.minutes
	end
	...
	Device.create(id: 2, temp_min: 5, temp_max: 35, user:u1, token4write: 'secret2', picture: p2)
	t = Time.now - 1.day
	100.times do

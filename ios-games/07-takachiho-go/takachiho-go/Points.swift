...
class Points {
    ...
    init(){
        ...
        array += [Point("Aisome", kanji:"逢初天神社", lat:32.707272, lng:131.317846,difficulty:1, gods: [])]
        ...
        array += [Point("Miyatoshi", kanji:"端午宮歳大明神", lat:32.7123342, lng:131.3272841,difficulty:1, gods: [])]

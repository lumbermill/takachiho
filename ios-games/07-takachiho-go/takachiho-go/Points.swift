...
class Points {
    ...
    init(){
        ...
        array += [Point("Shimonohachiman", kanji:"下野八幡大神社", lat:32.745196, lng:131.307631,difficulty:3)]
        array += [Point("Hachudairyuou", kanji:"八大龍王水神社", lat:32.73022, lng:131.356878,difficulty:2)]
        array += [Point("Aisome", kanji:"逢初天神社", lat:32.707272, lng:131.317846,difficulty:1)]
        ...
        array += [Point("Miyatoshi", kanji:"端午宮歳大明神", lat:32.7123342, lng:131.3272841,difficulty:1)]

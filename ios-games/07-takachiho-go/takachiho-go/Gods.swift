...
class Gods {
    ...
    init(){
        array += [God("1", kanji: "伊邪那美命", kana: "イザナミノミコト",desc: "")]
        array += [God("2", kanji: "伊邪那岐命", kana: "イザナギノミコト",desc: "")]
        array += [God("3", kanji: "天照大御神", kana: "アマテラスオオミカミ",desc: "")]
        array += [God("4", kanji: "国狭土尊", kana: "クニサヅチノミコト",desc: "")]
        array += [God("5", kanji: "国常立尊", kana: "クニトコタチノミコト",desc: "")]
        array += [God("6", kanji: "天鈿女命", kana: "アマノウズメノミコト",desc: "")]
        array += [God("7", kanji: "猿田彦命", kana: "サルタヒコノミコト",desc: "交通安全、教育の神")]
        array += [God("8", kanji: "八大龍王神", kana: "ハチダイリュウオウ",desc: "水神様")]
        array += [God("9", kanji: "玉依毘売命", kana: "タマヨリヒメ",desc: "神武天皇の母神で育児の神")]
        array += [God("10", kanji: "豊玉毘売命", kana: "トヨタマヒメ",desc: "神武天皇の祖母で風難除けの神様")]
        array += [God("11", kanji: "八幡神", kana: "ハチマンシン",desc: "鍛冶や農業の神")]
        array += [God("12", kanji: "牛神大明神", kana: "ウシガミダイミョウジン",desc: "畜産（牛馬）の神")]
        ...
        array += [God("28", kanji: "木花咲耶姫", kana: "コノハナサクヤヒメ", desc: "")]
        array += [God("29", kanji: "瓊瓊杵命", kana: "ニニギノミコト", desc: "")]
        array += [God("30", kanji: "大年神", kana: "オオトシガミ", desc: "穀物、田植えの神様")]
        array += [God("31", kanji: "大山祇命", kana: "オオヤマヅミノミコト", desc: "山、狩猟の神")]

...
public class FeatureDescription {
	public static void main(String[] args) {
		...
		// 画像データ1の読み込み
		Mat sourceImage1 = Highgui.imread(resourcePath("tortoise.png"));
		...
		// 以下、画像2の特徴量抽出処理
		Mat sourceImage2 = Highgui.imread(resourcePath("tortoise_rot.png"));
		...
		DMatch[] smallDistanceMatches = new DMatch[60];
		for (int i = 0; i < Math.min(matchArray.length, 60); i++) {
		...
		Highgui.imwrite("descriptors_match.png", output);
	}
